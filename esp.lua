...
local Config = { WindowName = "Light "..temptable.version.." ", Color = Color3.fromRGB(250, 249, 0), Keybind = Enum.KeyCode.Semicolon}
...
information:CreateLabel("Place version: "..game.PlaceVersion)
information:CreateLabel("Script by Kwizichka")
information:CreateLabel("Originally by Kwizichka")
local gainedhoneylabel = information:CreateLabel("Gained Honey: 0")
information:CreateButton("Discord Invite", function() setclipboard("https://discord.gg/JnKYe3M3") end)
...
farmsettings:CreateSlider("Walk Speed", 0, 70, 60, false, function(Value) kocmoc.vars.walkspeed = Value end)
